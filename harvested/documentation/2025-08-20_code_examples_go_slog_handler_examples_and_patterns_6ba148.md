...
confidence: 0.95
harvested_at: '2025-08-20T00:38:01.181517'
profile: code_examples
source: https://github.com/golang/example/tree/master/slog-handler-guide
topic: Go slog handler examples and patterns
---

# Go slog handler examples and patterns

[Skip to content](https://github.com/golang/example/tree/master/slog-handler-guide#start-of-content)
## Navigation Menu
Toggle navigation
[ ](https://github.com/)
[ Sign in ](https://github.com/login?return_to=https%3A%2F%2Fgithub.com%2Fgolang%2Fexample%2Ftree%2Fmaster%2Fslog-handler-guide)
Appearance settings
  * Product 
...
[ Sign in ](https://github.com/login?return_to=https%3A%2F%2Fgithub.com%2Fgolang%2Fexample%2Ftree%2Fmaster%2Fslog-handler-guide)
[ Sign up ](https://github.com/signup?ref_cta=Sign+up&ref_loc=header+logged+out&ref_page=%2F%3Cuser-name%3E%2F%3Crepo-name%3E%2Ffiles%2Fdisambiguate&source=header-repo&source_repo=golang%2Fexample)
Appearance settings
Resetting focus
You signed in with another tab or window. [Reload](https://github.com/golang/example/tree/master/slog-handler-guide) to refresh your session. You signed out in another tab or window. [Reload](https://github.com/golang/example/tree/master/slog-handler-guide) to refresh your session. You switched accounts on another tab or window. [Reload](https://github.com/golang/example/tree/master/slog-handler-guide) to refresh your session. Dismiss alert
{{ message }}
[ golang ](https://github.com/golang) / **[example](https://github.com/golang/example) ** Public
  * [ Notifications ](https://github.com/login?return_to=%2Fgolang%2Fexample) You must be signed in to change notification settings
  * [ Fork 956 ](https://github.com/login?return_to=%2Fgolang%2Fexample)
  * [ Star  2.9k ](https://github.com/login?return_to=%2Fgolang%2Fexample)


  * [ Code ](https://github.com/golang/example)
  * [ Pull requests 8 ](https://github.com/golang/example/pulls)
  * [ Actions ](https://github.com/golang/example/actions)
  * [ Projects 0 ](https://github.com/golang/example/projects)
  * [ Security ](https://github.com/golang/example/security)
[ ](https://github.com/golang/example/security)
[ ](https://github.com/golang/example/security)
[ ](https://github.com/golang/example/security)
### [ Uh oh!  ](https://github.com/golang/example/security)
[There was an error while loading. ](https://github.com/golang/example/security)[Please reload this page](https://github.com/golang/example/tree/master/slog-handler-guide).
  * [ Insights ](https://github.com/golang/example/pulse)


Additional navigation options
  * [ Code  ](https://github.com/golang/example)
  * [ Pull requests  ](https://github.com/golang/example/pulls)
  * [ Actions  ](https://github.com/golang/example/actions)
  * [ Projects  ](https://github.com/golang/example/projects)
  * [ Security  ](https://github.com/golang/example/security)
  * [ Insights  ](https://github.com/golang/example/pulse)
...
## Breadcrumbs
  1. [example](https://github.com/golang/example/tree/master)
...
More options
## Latest commit
[![jba](https://avatars.githubusercontent.com/u/18483045?v=4&size=40)](https://github.com/jba)[jba](https://github.com/golang/example/commits?author=jba)
[weave: fix %include parsing, add highlighting](https://github.com/golang/example/commit/e8420e48cb0ab72c0dc1ac230329e313ed218851)
Open commit detailssuccess
May 20, 2025
[e8420e4](https://github.com/golang/example/commit/e8420e48cb0ab72c0dc1ac230329e313ed218851) · May 20, 2025
## History
[History](https://github.com/golang/example/commits/master/slog-handler-guide)
Open commit details
[](https://github.com/golang/example/commits/master/slog-handler-guide)
## Breadcrumbs
  1. [example](https://github.com/golang/example/tree/master)
...
---|---|---|---  
### parent directory
[..](https://github.com/golang/example/tree/master)  
[indenthandler1](https://github.com/golang/example/tree/master/slog-handler-guide/indenthandler1 "indenthandler1")| [indenthandler1](https://github.com/golang/example/tree/master/slog-handler-guide/indenthandler1 "indenthandler1")| [slog-handler-guide: handler example: Enabled method](https://github.com/golang/example/commit/f15fe1c962335adaff0ec060f71395b95c8fa125 "slog-handler-guide: handler example: Enabled method
...
Reviewed-by: Ian Cottrell <iancottrell@google.com>")| Jul 25, 2023  
[indenthandler2](https://github.com/golang/example/tree/master/slog-handler-guide/indenthandler2 "indenthandler2")| [indenthandler2](https://github.com/golang/example/tree/master/slog-handler-guide/indenthandler2 "indenthandler2")| [slog-handler-guide: WithXXX methods without pre-formatting](https://github.com/golang/example/commit/183ca0816142e96dd3343c0117797c4ccde27a0f "slog-handler-guide: WithXXX methods without pre-formatting
Change-Id: Ia95d8ddd50eb72bef057768d88b216d7b9809c58
Reviewed-on: https://go-review.googlesource.com/c/example/+/511576
TryBot-Result: Gopher Robot <gobot@golang.org>
Run-TryBot: Jonathan Amsterdam <jba@google.com>
Reviewed-by: Ian Cottrell <iancottrell@google.com>")| Jul 25, 2023  
[indenthandler3](https://github.com/golang/example/tree/master/slog-handler-guide/indenthandler3 "indenthandler3")| [indenthandler3](https://github.com/golang/example/tree/master/slog-handler-guide/indenthandler3 "indenthandler3")| [slog-handler-guide: add testing section](https://github.com/golang/example/commit/b766721567ce15e3228b59ac1dd271e5fec9b2c0 "slog-handler-guide: add testing section
...
Run-TryBot: Jonathan Amsterdam <jba@google.com>")| Jul 26, 2023  
[indenthandler4](https://github.com/golang/example/tree/master/slog-handler-guide/indenthandler4 "indenthandler4")| [indenthandler4](https://github.com/golang/example/tree/master/slog-handler-guide/indenthandler4 "indenthandler4")| [slog-handler-guide: speed section](https://github.com/golang/example/commit/344698fc2aecde701fe14f7937775a7ce2eee8e8 "slog-handler-guide: speed section
Change-Id: If06f51747e6e4926d95e88840ab5fdce5f9a0189
Reviewed-on: https://go-review.googlesource.com/c/example/+/513457
Reviewed-by: Ian Cottrell <iancottrell@google.com>
TryBot-Result: Gopher Robot <gobot@golang.org>
Run-TryBot: Jonathan Amsterdam <jba@google.com>")| Aug 3, 2023  
[Makefile](https://github.com/golang/example/blob/master/slog-handler-guide/Makefile "Makefile")| [Makefile](https://github.com/golang/example/blob/master/slog-handler-guide/Makefile "Makefile")| [slog-handler-guide: guide to writing a slog Handler](https://github.com/golang/example/commit/72e55f1f1d3a45c74af107258f35ade8f91d736f "slog-handler-guide: guide to writing a slog Handler
...
Run-TryBot: Jonathan Amsterdam <jba@google.com>
Reviewed-by: Ian Cottrell <iancottrell@google.com>")| Jul 25, 2023  
[README.md](https://github.com/golang/example/blob/master/slog-handler-guide/README.md "README.md")| [README.md](https://github.com/golang/example/blob/master/slog-handler-guide/README.md "README.md")| [weave: fix %include parsing, add highlighting](https://github.com/golang/example/commit/e8420e48cb0ab72c0dc1ac230329e313ed218851 "weave: fix %include parsing, add highlighting
Recognize that
 %include file -
...
LUCI-TryBot-Result: Go LUCI <golang-scoped@luci-project-accounts.iam.gserviceaccount.com>")| May 20, 2025  
[guide.md](https://github.com/golang/example/blob/master/slog-handler-guide/guide.md "guide.md")| [guide.md](https://github.com/golang/example/blob/master/slog-handler-guide/guide.md "guide.md")| [example/slog-handler-guide: run `make`](https://github.com/golang/example/commit/f8bc3a00c46867f81091612ae6792ad64e1c7af9 "example/slog-handler-guide: run `make`
...
Auto-Submit: Jonathan Amsterdam <jba@google.com>")| Apr 25, 2025  
View all files  
## [README.md](https://github.com/golang/example/tree/master/slog-handler-guide#readme)
Outline
# A Guide to Writing `slog` Handlers
[](https://github.com/golang/example/tree/master/slog-handler-guide#a-guide-to-writing-slog-handlers)
This document is maintained by Jonathan Amsterdam `jba@google.com`.
# Contents
[](https://github.com/golang/example/tree/master/slog-handler-guide#contents)
  1. [Introduction](https://github.com/golang/example/tree/master/slog-handler-guide#introduction)
  2. [Loggers and their handlers](https://github.com/golang/example/tree/master/slog-handler-guide#loggers-and-their-handlers)
  3. [Implementing `Handler` methods](https://github.com/golang/example/tree/master/slog-handler-guide#implementing-handler-methods)
    1. [The `Enabled` method](https://github.com/golang/example/tree/master/slog-handler-guide#the-enabled-method)
    2. [The `Handle` method](https://github.com/golang/example/tree/master/slog-handler-guide#the-handle-method)
    3. [The `WithAttrs` method](https://github.com/golang/example/tree/master/slog-handler-guide#the-withattrs-method)
    4. [The `WithGroup` method](https://github.com/golang/example/tree/master/slog-handler-guide#the-withgroup-method)
    5. [Testing](https://github.com/golang/example/tree/master/slog-handler-guide#testing)
  4. [General considerations](https://github.com/golang/example/tree/master/slog-handler-guide#general-considerations)
    1. [Copying records](https://github.com/golang/example/tree/master/slog-handler-guide#copying-records)
    2. [Concurrency safety](https://github.com/golang/example/tree/master/slog-handler-guide#concurrency-safety)
    3. [Robustness](https://github.com/golang/example/tree/master/slog-handler-guide#robustness)
    4. [Speed](https://github.com/golang/example/tree/master/slog-handler-guide#speed)


# Introduction
[](https://github.com/golang/example/tree/master/slog-handler-guide#introduction)
The standard library’s `log/slog` package has a two-part design. A "frontend," implemented by the `Logger` type, gathers structured log information like a message, level, and attributes, and passes them to a "backend," an implementation of the `Handler` interface. The package comes with two built-in handlers that should usually be adequate. But you may need to write your own handler, and that is not always straightforward. This guide is here to help.
# Loggers and their handlers
[](https://github.com/golang/example/tree/master/slog-handler-guide#loggers-and-their-handlers)
Writing a handler requires an understanding of how the `Logger` and `Handler` types work together.
Each logger contains a handler. Certain `Logger` methods do some preliminary work, such as gathering key-value pairs into `Attr`s, and then call one or more `Handler` methods. These `Logger` methods are `With`, `WithGroup`, and the output methods like `Info`, `Error` and so on.
...
[](https://github.com/golang/example/tree/master/slog-handler-guide#implementing-handler-methods)
We can now talk about the four `Handler` methods in detail. Along the way, we will write a handler that formats logs using a format reminiscent of YAML. It will display this log output call:
```
...
The mutex will be used to ensure that writes to the `io.Writer` happen atomically. Unusually, `IndentHandler` holds a pointer to a `sync.Mutex` rather than holding a `sync.Mutex` directly. There is a good reason for that, which we'll explain [later](https://github.com/golang/example/tree/master/slog-handler-guide#getting-the-mutex-right).
...
## The `Enabled` method
[](https://github.com/golang/example/tree/master/slog-handler-guide#the-enabled-method)
...
## The `Handle` method
[](https://github.com/golang/example/tree/master/slog-handler-guide#the-handle-method)
...
The first line allocates a `[]byte` that should be large enough for most log output. Allocating a buffer with some initial, fairly large capacity is a simple but significant optimization: it avoids the repeated copying and allocation that happen when the initial slice is empty or small. We'll return to this line in the section on [speed](https://github.com/golang/example/tree/master/slog-handler-guide#speed) and show how we can do even better.
...
[](https://github.com/golang/example/tree/master/slog-handler-guide#the-withattrs-method)
...
[](https://github.com/golang/example/tree/master/slog-handler-guide#the-withgroup-method)
...
[](https://github.com/golang/example/tree/master/slog-handler-guide#without-pre-formatting)
...
[](https://github.com/golang/example/tree/master/slog-handler-guide#getting-the-mutex-right)
...
This `WithGroup` is a lot like the previous one: it just remembers the new group, which is unopened initially.
```
func (h *IndentHandler) WithGroup(name string) slog.Handler {
	if name == "" {
		return h
...
[](https://github.com/golang/example/tree/master/slog-handler-guide#general-considerations)
## Copying records
[](https://github.com/golang/example/tree/master/slog-handler-guide#copying-records)
...
## Concurrency safety
[](https://github.com/golang/example/tree/master/slog-handler-guide#concurrency-safety)
...
## Robustness
[](https://github.com/golang/example/tree/master/slog-handler-guide#robustness)
...
For example, the usual advice when a function discovers a problem, like an invalid argument, is to panic or return an error. The built-in handlers do not follow that advice. Few things are more frustrating than being unable to debug a problem that causes logging to fail; it is better to produce some output, however imperfect, than to produce none at all. That is why methods like `Logger.Info` convert programming bugs in their list of key-value pairs, like missing values or malformed keys, into `Attr`s that contain as much information as possible.
...
## Speed
[](https://github.com/golang/example/tree/master/slog-handler-guide#speed)
...
## Source Information
- URL: https://github.com/golang/example/tree/master/slog-handler-guide
- Harvested: 2025-08-20T00:38:01.181517
- Profile: code_examples
- Agent: architect
