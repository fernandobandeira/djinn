...
confidence: 0.95
harvested_at: '2025-08-19T23:14:24.253439'
profile: deep_research
source: https://martinfowler.com/articles/practical-test-pyramid.html
topic: Testing Pyramid vs Trophy vs Diamond Patterns
---

# Testing Pyramid vs Trophy vs Diamond Patterns

[![](https://martinfowler.com/mf-name-white.png)](https://martinfowler.com)
[](https://martinfowler.com/articles/practical-test-pyramid.html#navmenu-bottom)
...
## Table of Contents
  * [Top](https://martinfowler.com/articles/practical-test-pyramid.html#top)
  * [The Importance of (Test) Automation](https://martinfowler.com/articles/practical-test-pyramid.html#TheImportanceOftestAutomation)
  * [The Test Pyramid](https://martinfowler.com/articles/practical-test-pyramid.html#TheTestPyramid)
  * [Tools and Libraries We'll Look at](https://martinfowler.com/articles/practical-test-pyramid.html#ToolsAndLibrariesWellLookAt)
  * [The Sample Application](https://martinfowler.com/articles/practical-test-pyramid.html#TheSampleApplication)
    * [Functionality](https://martinfowler.com/articles/practical-test-pyramid.html#Functionality)
    * [High-level Structure](https://martinfowler.com/articles/practical-test-pyramid.html#High-levelStructure)
    * [Internal Architecture](https://martinfowler.com/articles/practical-test-pyramid.html#InternalArchitecture)
  * [Unit tests](https://martinfowler.com/articles/practical-test-pyramid.html#UnitTests)
    * [What's a Unit?](https://martinfowler.com/articles/practical-test-pyramid.html#WhatsAUnit)
    * [Sociable and Solitary](https://martinfowler.com/articles/practical-test-pyramid.html#SociableAndSolitary)
    * [Mocking and Stubbing](https://martinfowler.com/articles/practical-test-pyramid.html#MockingAndStubbing)
    * [What to Test?](https://martinfowler.com/articles/practical-test-pyramid.html#WhatToTest)
    * [Test Structure](https://martinfowler.com/articles/practical-test-pyramid.html#TestStructure)
    * [Implementing a Unit Test](https://martinfowler.com/articles/practical-test-pyramid.html#ImplementingAUnitTest)
  * [Integration Tests](https://martinfowler.com/articles/practical-test-pyramid.html#IntegrationTests)
    * [Database Integration](https://martinfowler.com/articles/practical-test-pyramid.html#DatabaseIntegration)
    * [Integration With Separate Services](https://martinfowler.com/articles/practical-test-pyramid.html#IntegrationWithSeparateServices)
  * [Contract Tests](https://martinfowler.com/articles/practical-test-pyramid.html#ContractTests)
    * [Consumer Test (our team)](https://martinfowler.com/articles/practical-test-pyramid.html#ConsumerTestourTeam)
    * [Provider Test (the other team)](https://martinfowler.com/articles/practical-test-pyramid.html#ProviderTesttheOtherTeam)
    * [Provider Test (our team)](https://martinfowler.com/articles/practical-test-pyramid.html#ProviderTestourTeam)
  ...
  * [End-to-End Tests](https://martinfowler.com/articles/practical-test-pyramid.html#End-to-endTests)
    * [User Interface End-to-End Test](https://martinfowler.com/articles/practical-test-pyramid.html#UserInterfaceEnd-to-endTest)
    * [REST API End-to-End Test](https://martinfowler.com/articles/practical-test-pyramid.html#RestApiEnd-to-endTest)
  * [Acceptance Tests — Do Your Features Work Correctly?](https://martinfowler.com/articles/practical-test-pyramid.html#acceptance)
  * [Exploratory Testing](https://martinfowler.com/articles/practical-test-pyramid.html#ExploratoryTesting)
  ...
  * [Putting Tests Into Your Deployment Pipeline](https://martinfowler.com/articles/practical-test-pyramid.html#PuttingTestsIntoYourDeploymentPipeline)
  * [Avoid Test Duplication](https://martinfowler.com/articles/practical-test-pyramid.html#AvoidTestDuplication)
  * [Writing Clean Test Code](https://martinfowler.com/articles/practical-test-pyramid.html#WritingCleanTestCode)
  * [Conclusion](https://martinfowler.com/articles/practical-test-pyramid.html#Conclusion)


### Sidebars
  * [But I Really Need to Test This Private Method](https://martinfowler.com/articles/practical-test-pyramid.html#private-methods-sidebar)
  * [Specialised Test Helpers](https://martinfowler.com/articles/practical-test-pyramid.html#SpecialisedTestHelpers)


# The Practical Test Pyramid
_The “Test Pyramid” is a metaphor that tells us to group software tests into buckets of different granularity. It also gives an idea of how many tests we should have in each of these groups. Although the concept of the Test Pyramid has been around for a while, teams still struggle to put it into practice properly. This article revisits the original concept of the Test Pyramid and shows how you can put this into practice. It shows which kinds of tests you should be looking for in the different levels of the pyramid and gives practical examples on how these can be implemented._
26 February 2018
[![Photo of Ham Vocke](https://martinfowler.com/articles/practical-test-pyramid/ham.jpg)](http://www.hamvocke.com)
...
**Translations:**[Brazilian Portuguese](https://github.com/paulojunior-ufla/piramide-de-teste-pratica) · [Chinese](https://insights.thoughtworks.cn/practical-test-pyramid/)
## Contents
  * [The Importance of (Test) Automation](https://martinfowler.com/articles/practical-test-pyramid.html#TheImportanceOftestAutomation)
  * [The Test Pyramid](https://martinfowler.com/articles/practical-test-pyramid.html#TheTestPyramid)
  * [Tools and Libraries We'll Look at](https://martinfowler.com/articles/practical-test-pyramid.html#ToolsAndLibrariesWellLookAt)
...
Whenever I find myself in this situation I usually come to the conclusion that the class I'm testing is already too complex. It's doing too much and violates the _single responsibility_ principle - the _S_ of the five [SOLID](https://en.wikipedia.org/wiki/SOLID_\(object-oriented_design\)) principles.
...
As you often spread the consuming and providing services across different teams you find yourself in the situation where you have to clearly specify the interface between these services (the so called **contract**). Traditionally companies have approached this problem in the following way:
  * Write a long and detailed interface specification (the _contract_)
...
_26 February 2018:_ Published installment with UI tests
_22 February 2018:_ Published installment with contract tests
_20 February 2018:_ Published installment with integration tests
_15 February 2018:_ Published installment with unit tests
_14 February 2018:_ First installment, introducing the pyramid and the sample application
## Topics
[Architecture](https://martinfowler.com/architecture)
[Refactoring](https://refactoring.com)
[Agile](https://martinfowler.com/agile.html)
...
- Harvested: 2025-08-19T23:14:24.253439
- Profile: deep_research
- Agent: architect
