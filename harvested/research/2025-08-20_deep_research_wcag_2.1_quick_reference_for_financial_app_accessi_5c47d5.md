...
agent_context: ux
confidence: 0.95
harvested_at: '2025-08-20T01:13:29.960378'
profile: deep_research
source: https://www.w3.org/WAI/WCAG21/quickref/
topic: WCAG 2.1 Quick Reference for Financial App Accessibility
---

# WCAG 2.1 Quick Reference for Financial App Accessibility

[![W3C](https://www.w3.org/WAI/WCAG22/quickref/img/w3c.svg)](https://w3.org/)[![Web Accessibility Initiative](https://www.w3.org/WAI/WCAG22/quickref/img/wai.svg)](https://w3.org/WAI/)
...
The **Share this view** button provides a link to this tool with the filters you have set. The SHARE buttons provide links to individual success criteria.
  * Hide
  * [ Contents](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#col_overview)
  * [ Filter](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#col_customize)


  * [**1.** Perceivable](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#principle1)
    * [**1.1** Text Alternatives](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#text-alternatives)
      * [**1.1.1** Non-text Content](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#non-text-content)
    * [**1.2** Time-based Media](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#time-based-media)
      * [**1.2.1** Audio-only and Video-only (Prerecorded)](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#audio-only-and-video-only-prerecorded)
      * [**1.2.2** Captions (Prerecorded)](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#captions-prerecorded)
      * [**1.2.3** Audio Description or Media Alternative (Prerecorded)](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#audio-description-or-media-alternative-prerecorded)
      * [**1.2.4** Captions (Live)](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#captions-live)
      * [**1.2.5** Audio Description (Prerecorded)](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#audio-description-prerecorded)
      * [**1.2.6** Sign Language (Prerecorded)](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#sign-language-prerecorded)
      * [**1.2.7** Extended Audio Description (Prerecorded)](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#extended-audio-description-prerecorded)
      * [**1.2.8** Media Alternative (Prerecorded)](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#media-alternative-prerecorded)
      * [**1.2.9** Audio-only (Live)](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#audio-only-live)
    * [**1.3** Adaptable](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#adaptable)
      * [**1.3.1** Info and Relationships](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#info-and-relationships)
      * [**1.3.2** Meaningful Sequence](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#meaningful-sequence)
      * [**1.3.3** Sensory Characteristics](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#sensory-characteristics)
      * [**1.3.4** Orientation](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#orientation)
      * [**1.3.5** Identify Input Purpose](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#identify-input-purpose)
      * [**1.3.6** Identify Purpose](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#identify-purpose)
    * [**1.4** Distinguishable](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#distinguishable)
      * [**1.4.1** Use of Color](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#use-of-color)
      * [**1.4.2** Audio Control](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#audio-control)
      * [**1.4.3** Contrast (Minimum)](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#contrast-minimum)
      * [**1.4.4** Resize Text](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#resize-text)
      * [**1.4.5** Images of Text](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#images-of-text)
      * [**1.4.6** Contrast (Enhanced)](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#contrast-enhanced)
      * [**1.4.7** Low or No Background Audio](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#low-or-no-background-audio)
      * [**1.4.8** Visual Presentation](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#visual-presentation)
      * [**1.4.9** Images of Text (No Exception)](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#images-of-text-no-exception)
      * [**1.4.10** Reflow](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#reflow)
      * [**1.4.11** Non-text Contrast](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#non-text-contrast)
      * [**1.4.12** Text Spacing](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#text-spacing)
      * [**1.4.13** Content on Hover or Focus](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#content-on-hover-or-focus)
  * [**2.** Operable](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#principle2)
    * [**2.1** Keyboard Accessible](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#keyboard-accessible)
      * [**2.1.1** Keyboard](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#keyboard)
      * [**2.1.2** No Keyboard Trap](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#no-keyboard-trap)
      * [**2.1.3** Keyboard (No Exception)](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#keyboard-no-exception)
      * [**2.1.4** Character Key Shortcuts](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#character-key-shortcuts)
    * [**2.2** Enough Time](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#enough-time)
      * [**2.2.1** Timing Adjustable](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#timing-adjustable)
      * [**2.2.2** Pause, Stop, Hide](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#pause-stop-hide)
      * [**2.2.3** No Timing](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#no-timing)
      * [**2.2.4** Interruptions](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#interruptions)
      * [**2.2.5** Re-authenticating](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#re-authenticating)
      * [**2.2.6** Timeouts](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#timeouts)
    * [**2.3** Seizures and Physical Reactions](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#seizures-and-physical-reactions)
      * [**2.3.1** Three Flashes or Below Threshold](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#three-flashes-or-below-threshold)
      * [**2.3.2** Three Flashes](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#three-flashes)
      * [**2.3.3** Animation from Interactions](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#animation-from-interactions)
    * [**2.4** Navigable](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#navigable)
      * [**2.4.1** Bypass Blocks](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#bypass-blocks)
      * [**2.4.2** Page Titled](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#page-titled)
      * [**2.4.3** Focus Order](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#focus-order)
      * [**2.4.4** Link Purpose (In Context)](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#link-purpose-in-context)
      * [**2.4.5** Multiple Ways](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#multiple-ways)
      * [**2.4.6** Headings and Labels](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#headings-and-labels)
      * [**2.4.7** Focus Visible](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#focus-visible)
      * [**2.4.8** Location](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#location)
      * [**2.4.9** Link Purpose (Link Only)](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#link-purpose-link-only)
      * [**2.4.10** Section Headings](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#section-headings)
      * [**2.4.11** Focus Not Obscured (Minimum)](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#focus-not-obscured-minimum)
      * [**2.4.12** Focus Not Obscured (Enhanced)](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#focus-not-obscured-enhanced)
      * [**2.4.13** Focus Appearance](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#focus-appearance)
    * [**2.5** Input Modalities](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#input-modalities)
      * [**2.5.1** Pointer Gestures](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#pointer-gestures)
      * [**2.5.2** Pointer Cancellation](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#pointer-cancellation)
      * [**2.5.3** Label in Name](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#label-in-name)
      * [**2.5.4** Motion Actuation](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#motion-actuation)
      * [**2.5.5** Target Size (Enhanced)](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#target-size-enhanced)
      * [**2.5.6** Concurrent Input Mechanisms](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#concurrent-input-mechanisms)
      * [**2.5.7** Dragging Movements](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#dragging-movements)
      * [**2.5.8** Target Size (Minimum)](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#target-size-minimum)
  * [**3.** Understandable](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#principle3)
    * [**3.1** Readable](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#readable)
      * [**3.1.1** Language of Page](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#language-of-page)
      * [**3.1.2** Language of Parts](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#language-of-parts)
      * [**3.1.3** Unusual Words](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#unusual-words)
      * [**3.1.4** Abbreviations](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#abbreviations)
      * [**3.1.5** Reading Level](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#reading-level)
      * [**3.1.6** Pronunciation](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#pronunciation)
    * [**3.2** Predictable](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#predictable)
      * [**3.2.1** On Focus](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#on-focus)
      * [**3.2.2** On Input](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#on-input)
      * [**3.2.3** Consistent Navigation](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#consistent-navigation)
      * [**3.2.4** Consistent Identification](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#consistent-identification)
      * [**3.2.5** Change on Request](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#change-on-request)
      * [**3.2.6** Consistent Help](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#consistent-help)
    * [**3.3** Input Assistance](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#input-assistance)
      * [**3.3.1** Error Identification](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#error-identification)
      * [**3.3.2** Labels or Instructions](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#labels-or-instructions)
      * [**3.3.3** Error Suggestion](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#error-suggestion)
      * [**3.3.4** Error Prevention (Legal, Financial, Data)](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#error-prevention-legal-financial-data)
      * [**3.3.5** Help](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#help)
      * [**3.3.6** Error Prevention (All)](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#error-prevention-all)
      * [**3.3.7** Redundant Entry](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#redundant-entry)
      * [**3.3.8** Accessible Authentication (Minimum)](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#accessible-authentication-minimum)
      * [**3.3.9** Accessible Authentication (Enhanced)](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#accessible-authentication-enhanced)
  * [**4.** Robust](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#principle4)
    * [**4.1** Compatible](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#compatible)
      * [**4.1.1** Parsing](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#parsing)
      * [**4.1.2** Name, Role, Value](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#name-role-value)
      * [**4.1.3** Status Messages](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#status-messages)
...
Show Sidebar
Loading Loaded
Selected Filters: **WCAG 2.1:** all success criteria and all techniques. [(What did the filter remove?)](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#hiddensc)
Clear filters
Expand **all** sections
Share
Link to this view, with the filters you have selected: Shortcut to copy the link: `ctrl`+`C` _or_ `⌘``C`
Close
...
###### Situation A: If a short description can serve the same purpose and present the same information as the non-text content:
  * [G94: Providing short text alternative for non-text content that serves the same purpose and presents the same information as the non-text content](https://www.w3.org/WAI/WCAG22/Techniques/general/G94) using one of the following **[Short text alternative techniques for Situation A](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#text-equiv-all-situation-a-shorttext) **:
...
###### Situation B: If a short description can not serve the same purpose and present the same information as the non-text content (e.g., a chart or diagram):
  * [G95: Providing short text alternatives that provide a brief description of the non-text content](https://www.w3.org/WAI/WCAG22/Techniques/general/G95) using one of the following **[Short text alternative techniques for Situation B](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#text-equiv-all-situation-b-shorttext) ** **AND** one of the following **[Long text alternative techniques for Situation B](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#text-equiv-all-situation-b-longtext) **:
...
###### Situation C: If non-text content is a control or accepts user input:
  * [G82: Providing a text alternative that identifies the purpose of the non-text content](https://www.w3.org/WAI/WCAG22/Techniques/general/G82) using one of the following **[Text alternative techniques for controls and input for Situation C](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#text-equiv-all-situation-c-controls) **:
...
###### Situation D: If non-text content is time-based media (including live video-only and live audio-only); a test or exercise that would be invalid if presented in text; or primarily intended to create a specific sensory experience:
  * Providing a descriptive label using one of the following **[Short text alternative techniques for Situation D](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#text-equiv-all-situation-d-shorttext) **:
  * [G68: Providing a short text alternative that describes the purpose of live audio-only and live video-only content](https://www.w3.org/WAI/WCAG22/Techniques/general/G68) using one of the following **[Short text alternative techniques for Situation D](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#text-equiv-all-situation-d-shorttext) **:
...
###### Situation F: If the non-text content should be ignored by assistive technology:
  * Implementing or marking the non-text content so that it will be ignored by assistive technology using one of the following **[Techniques to indicate that text alternatives are not required for Situation F](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#text-equiv-all-situation-f-notrequired) **:
...
[ SHARE](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#non-text-content)
Link to this section: Shortcut to copy the link: `ctrl`+`C` _or_ `⌘``C`
E-mail a link to this sectionClose
[ Back to top](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#top)
...
[ SHARE](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#audio-only-and-video-only-prerecorded)
Link to this section: Shortcut to copy the link: `ctrl`+`C` _or_ `⌘``C`
E-mail a link to this sectionClose
[ Back to top](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#top)
...
[ SHARE](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#captions-prerecorded)
Link to this section: Shortcut to copy the link: `ctrl`+`C` _or_ `⌘``C`
E-mail a link to this sectionClose
[ Back to top](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#top)
...
[ SHARE](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#audio-description-or-media-alternative-prerecorded)
Link to this section: Shortcut to copy the link: `ctrl`+`C` _or_ `⌘``C`
E-mail a link to this sectionClose
[ Back to top](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#top)
#### **1.2.4** Captions (Live)
...
_Note:_ Captions may be generated using real-time text translation service.
[ SHARE](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#captions-live)
Link to this section: Shortcut to copy the link: `ctrl`+`C` _or_ `⌘``C`
E-mail a link to this sectionClose
[ Back to top](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#top)
...
[ SHARE](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#audio-description-prerecorded)
Link to this section: Shortcut to copy the link: `ctrl`+`C` _or_ `⌘``C`
E-mail a link to this sectionClose
[ Back to top](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#top)
...
[ SHARE](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#sign-language-prerecorded)
Link to this section: Shortcut to copy the link: `ctrl`+`C` _or_ `⌘``C`
E-mail a link to this sectionClose
[ Back to top](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#top)
...
[ SHARE](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#extended-audio-description-prerecorded)
Link to this section: Shortcut to copy the link: `ctrl`+`C` _or_ `⌘``C`
E-mail a link to this sectionClose
[ Back to top](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#top)
...
[ SHARE](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#media-alternative-prerecorded)
Link to this section: Shortcut to copy the link: `ctrl`+`C` _or_ `⌘``C`
E-mail a link to this sectionClose
[ Back to top](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#top)
...
[ SHARE](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#audio-only-live)
Link to this section: Shortcut to copy the link: `ctrl`+`C` _or_ `⌘``C`
E-mail a link to this sectionClose
[ Back to top](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#top)
...
[ SHARE](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#info-and-relationships)
Link to this section: Shortcut to copy the link: `ctrl`+`C` _or_ `⌘``C`
E-mail a link to this sectionClose
[ Back to top](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#top)
...
[ SHARE](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#meaningful-sequence)
Link to this section: Shortcut to copy the link: `ctrl`+`C` _or_ `⌘``C`
E-mail a link to this sectionClose
[ Back to top](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#top)
...
_Note:_ For requirements related to color, refer to Guideline 1.4.
...
[ SHARE](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#sensory-characteristics)
Link to this section: Shortcut to copy the link: `ctrl`+`C` _or_ `⌘``C`
E-mail a link to this sectionClose
[ Back to top](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#top)
#### **1.3.4** Orientation
...
_Note:_ Examples where a particular display orientation may be essential are a bank check, a piano application, slides for a projector or television, or virtual reality content where content is not necessarily restricted to landscape or portrait display orientation.
...
[ SHARE](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#orientation)
Link to this section: Shortcut to copy the link: `ctrl`+`C` _or_ `⌘``C`
E-mail a link to this sectionClose
[ Back to top](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#top)
...
[ SHARE](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#identify-input-purpose)
Link to this section: Shortcut to copy the link: `ctrl`+`C` _or_ `⌘``C`
E-mail a link to this sectionClose
[ Back to top](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#top)
...
[ SHARE](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#identify-purpose)
Link to this section: Shortcut to copy the link: `ctrl`+`C` _or_ `⌘``C`
E-mail a link to this sectionClose
[ Back to top](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#top)
...
_Note:_ This success criterion addresses color perception specifically. Other forms of perception are covered in Guideline 1.3 including programmatic access to color and other visual presentation coding.
...
[ SHARE](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#use-of-color)
Link to this section: Shortcut to copy the link: `ctrl`+`C` _or_ `⌘``C`
E-mail a link to this sectionClose
[ Back to top](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#top)
#### **1.4.2** Audio Control
...
_Note:_ Since any content that does not meet this success criterion can interfere with a user's ability to use the whole page, all content on the web page (whether or not it is used to meet other success criteria) must meet this success criterion. See Conformance Requirement 5: Non-Interference.
...
[ SHARE](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#audio-control)
Link to this section: Shortcut to copy the link: `ctrl`+`C` _or_ `⌘``C`
E-mail a link to this sectionClose
[ Back to top](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#top)
...
[ SHARE](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#contrast-minimum)
Link to this section: Shortcut to copy the link: `ctrl`+`C` _or_ `⌘``C`
E-mail a link to this sectionClose
[ Back to top](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#top)
#### **1.4.4** Resize Text
...
[ SHARE](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#resize-text)
Link to this section: Shortcut to copy the link: `ctrl`+`C` _or_ `⌘``C`
E-mail a link to this sectionClose
[ Back to top](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#top)
...
[ SHARE](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#images-of-text)
Link to this section: Shortcut to copy the link: `ctrl`+`C` _or_ `⌘``C`
E-mail a link to this sectionClose
[ Back to top](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#top)
...
[ SHARE](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#contrast-enhanced)
Link to this section: Shortcut to copy the link: `ctrl`+`C` _or_ `⌘``C`
E-mail a link to this sectionClose
[ Back to top](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#top)
...
[ SHARE](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#low-or-no-background-audio)
Link to this section: Shortcut to copy the link: `ctrl`+`C` _or_ `⌘``C`
E-mail a link to this sectionClose
[ Back to top](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#top)
...
###### Fifth Requirement: Techniques to ensure text can be resized without assistive technology up to 200 percent in a way that does not require the user to scroll horizontally to read a line of text on a full-screen window
  * [G204: Not interfering with the user agent's reflow of text as the viewing window is narrowed](https://www.w3.org/WAI/WCAG22/Techniques/general/G204) OR
  * [G146: Using liquid layout](https://www.w3.org/WAI/WCAG22/Techniques/general/G146) _AND_ using measurements that are relative to other measurements in the content by using one or more of the following techniques:
...
[ SHARE](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#visual-presentation)
Link to this section: Shortcut to copy the link: `ctrl`+`C` _or_ `⌘``C`
E-mail a link to this sectionClose
[ Back to top](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#top)
...
[ SHARE](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#images-of-text-no-exception)
Link to this section: Shortcut to copy the link: `ctrl`+`C` _or_ `⌘``C`
E-mail a link to this sectionClose
[ Back to top](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#top)
#### **1.4.10** Reflow
...
_Note 1:_ 320 CSS pixels is equivalent to a starting viewport width of 1280 CSS pixels wide at 400% zoom. For web content which is designed to scroll horizontally (e.g., with vertical text), 256 CSS pixels is equivalent to a starting viewport height of 1024 CSS pixels at 400% zoom.
_Note 2:_ Examples of content which requires two-dimensional layout are images required for understanding (such as maps and diagrams), video, games, presentations, data tables (not individual cells), and interfaces where it is necessary to keep toolbars in view while manipulating content. It is acceptable to provide two-dimensional scrolling for such parts of the content.
...
[ SHARE](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#reflow)
Link to this section: Shortcut to copy the link: `ctrl`+`C` _or_ `⌘``C`
E-mail a link to this sectionClose
[ Back to top](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#top)
...
[ SHARE](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#non-text-contrast)
Link to this section: Shortcut to copy the link: `ctrl`+`C` _or_ `⌘``C`
E-mail a link to this sectionClose
[ Back to top](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#top)
#### **1.4.12** Text Spacing
...
_Note 1:_ Content is not required to use these text spacing values. The requirement is to ensure that when a user overrides the authored text spacing, content or functionality is not lost.
_Note 2:_ Writing systems for some languages use different text spacing settings, such as paragraph start indent. Authors are encouraged to follow locally available guidance for improving readability and legibility of text in their writing system.
...
[ SHARE](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#text-spacing)
Link to this section: Shortcut to copy the link: `ctrl`+`C` _or_ `⌘``C`
E-mail a link to this sectionClose
[ Back to top](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#top)
...
_Note 1:_ Examples of additional content controlled by the user agent include browser tooltips created through use of the HTML title attribute [HTML].
_Note 2:_ Custom tooltips, sub-menus, and other nonmodal popups that display on hover and focus are examples of additional content covered by this criterion.
_Note 3:_ This criterion applies to content that appears in addition to the triggering component itself. Since hidden components that are made visible on keyboard focus (such as links used to skip to another part of a page) do not present additional content they are not covered by this criterion.
...
[ SHARE](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#content-on-hover-or-focus)
Link to this section: Shortcut to copy the link: `ctrl`+`C` _or_ `⌘``C`
E-mail a link to this sectionClose
[ Back to top](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#top)
...
[ SHARE](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#keyboard)
Link to this section: Shortcut to copy the link: `ctrl`+`C` _or_ `⌘``C`
E-mail a link to this sectionClose
[ Back to top](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#top)
...
_Note:_ Since any content that does not meet this success criterion can interfere with a user's ability to use the whole page, all content on the web page (whether it is used to meet other success criteria or not) must meet this success criterion. See Conformance Requirement 5: Non-Interference.
...
[ SHARE](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#no-keyboard-trap)
Link to this section: Shortcut to copy the link: `ctrl`+`C` _or_ `⌘``C`
E-mail a link to this sectionClose
[ Back to top](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#top)
...
Note: Other techniques may also be sufficient if they meet the success criterion. See [Understanding Techniques.](https://www.w3.org/WAI/WCAG22/Understanding/understanding-techniques)
No additional techniques exist for this success criterion. Follow [techniques for Success Criterion 2.1.1](https://www.w3.org/WAI/WCAG22/quickref/keyboard#techniques). If that is not possible because there is a requirement for path-dependent input, then it is not possible to meet this Level AAA success criterion.
[ SHARE](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#keyboard-no-exception)
Link to this section: Shortcut to copy the link: `ctrl`+`C` _or_ `⌘``C`
E-mail a link to this sectionClose
[ Back to top](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#top)
...
[ SHARE](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#character-key-shortcuts)
Link to this section: Shortcut to copy the link: `ctrl`+`C` _or_ `⌘``C`
E-mail a link to this sectionClose
[ Back to top](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#top)
...
[ SHARE](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#timing-adjustable)
Link to this section: Shortcut to copy the link: `ctrl`+`C` _or_ `⌘``C`
E-mail a link to this sectionClose
[ Back to top](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#top)
...
[ SHARE](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#pause-stop-hide)
Link to this section: Shortcut to copy the link: `ctrl`+`C` _or_ `⌘``C`
E-mail a link to this sectionClose
[ Back to top](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#top)
#### **2.2.3** No Timing
...
[ SHARE](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#no-timing)
Link to this section: Shortcut to copy the link: `ctrl`+`C` _or_ `⌘``C`
E-mail a link to this sectionClose
[ Back to top](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#top)
#### **2.2.4** Interruptions
...
[ SHARE](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#interruptions)
Link to this section: Shortcut to copy the link: `ctrl`+`C` _or_ `⌘``C`
E-mail a link to this sectionClose
[ Back to top](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#top)
...
_Note:_ Refer to Techniques for Addressing Success Criterion 2.2.1 for techniques related to providing notifications about time limits.
...
[ SHARE](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#re-authenticating)
Link to this section: Shortcut to copy the link: `ctrl`+`C` _or_ `⌘``C`
E-mail a link to this sectionClose
[ Back to top](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#top)
#### **2.2.6** Timeouts
...
[ SHARE](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#timeouts)
Link to this section: Shortcut to copy the link: `ctrl`+`C` _or_ `⌘``C`
E-mail a link to this sectionClose
[ Back to top](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#top)
...
[ SHARE](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#three-flashes-or-below-threshold)
Link to this section: Shortcut to copy the link: `ctrl`+`C` _or_ `⌘``C`
E-mail a link to this sectionClose
[ Back to top](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#top)
#### **2.3.2** Three Flashes
...
[ SHARE](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#three-flashes)
Link to this section: Shortcut to copy the link: `ctrl`+`C` _or_ `⌘``C`
E-mail a link to this sectionClose
[ Back to top](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#top)
...
[ SHARE](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#animation-from-interactions)
Link to this section: Shortcut to copy the link: `ctrl`+`C` _or_ `⌘``C`
E-mail a link to this sectionClose
[ Back to top](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#top)
...
[ SHARE](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#bypass-blocks)
Link to this section: Shortcut to copy the link: `ctrl`+`C` _or_ `⌘``C`
E-mail a link to this sectionClose
[ Back to top](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#top)
#### **2.4.2** Page Titled
...
[ SHARE](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#page-titled)
Link to this section: Shortcut to copy the link: `ctrl`+`C` _or_ `⌘``C`
E-mail a link to this sectionClose
[ Back to top](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#top)
#### **2.4.3** Focus Order
...
[ SHARE](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#focus-order)
Link to this section: Shortcut to copy the link: `ctrl`+`C` _or_ `⌘``C`
E-mail a link to this sectionClose
[ Back to top](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#top)
...
[ SHARE](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#link-purpose-in-context)
Link to this section: Shortcut to copy the link: `ctrl`+`C` _or_ `⌘``C`
E-mail a link to this sectionClose
[ Back to top](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#top)
#### **2.4.5** Multiple Ways
...
[ SHARE](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#multiple-ways)
Link to this section: Shortcut to copy the link: `ctrl`+`C` _or_ `⌘``C`
E-mail a link to this sectionClose
[ Back to top](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#top)
...
_Note:_ Headings and labels must be programmatically determined, per Success Criterion 1.3.1.
[ SHARE](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#headings-and-labels)
Link to this section: Shortcut to copy the link: `ctrl`+`C` _or_ `⌘``C`
E-mail a link to this sectionClose
[ Back to top](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#top)
#### **2.4.7** Focus Visible
...
[ SHARE](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#focus-visible)
Link to this section: Shortcut to copy the link: `ctrl`+`C` _or_ `⌘``C`
E-mail a link to this sectionClose
[ Back to top](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#top)
#### **2.4.8** Location
...
[ SHARE](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#location)
Link to this section: Shortcut to copy the link: `ctrl`+`C` _or_ `⌘``C`
E-mail a link to this sectionClose
[ Back to top](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#top)
...
[ SHARE](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#link-purpose-link-only)
Link to this section: Shortcut to copy the link: `ctrl`+`C` _or_ `⌘``C`
E-mail a link to this sectionClose
[ Back to top](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#top)
...
[ SHARE](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#section-headings)
Link to this section: Shortcut to copy the link: `ctrl`+`C` _or_ `⌘``C`
E-mail a link to this sectionClose
[ Back to top](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#top)
...
_Note 2:_ Content opened by the _user_ may obscure the component receiving focus. If the user can reveal the focused component without advancing the keyboard focus, the component with focus is not considered visually hidden due to author-created content.
...
[ SHARE](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#focus-not-obscured-minimum)
Link to this section: Shortcut to copy the link: `ctrl`+`C` _or_ `⌘``C`
E-mail a link to this sectionClose
[ Back to top](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#top)
...
[ SHARE](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#focus-not-obscured-enhanced)
Link to this section: Shortcut to copy the link: `ctrl`+`C` _or_ `⌘``C`
E-mail a link to this sectionClose
[ Back to top](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#top)
#### **2.4.13** Focus Appearance
Level AAA(Added in 2.2)
When the keyboard focus indicator is visible, an area of the focus indicator meets all the following:  Show Hide full description
...
[ SHARE](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#focus-appearance)
Link to this section: Shortcut to copy the link: `ctrl`+`C` _or_ `⌘``C`
E-mail a link to this sectionClose
[ Back to top](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#top)
...
[ SHARE](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#pointer-gestures)
Link to this section: Shortcut to copy the link: `ctrl`+`C` _or_ `⌘``C`
E-mail a link to this sectionClose
[ Back to top](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#top)
...
_Note 1:_ Functions that emulate a keyboard or numeric keypad key press are considered essential.
_Note 2:_ This requirement applies to web content that interprets pointer actions (i.e., this does not apply to actions that are required to operate the user agent or assistive technology).
...
[ SHARE](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#pointer-cancellation)
Link to this section: Shortcut to copy the link: `ctrl`+`C` _or_ `⌘``C`
E-mail a link to this sectionClose
[ Back to top](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#top)
#### **2.5.3** Label in Name
...
_Note:_ A best practice is to have the text of the label at the start of the name.
...
[ SHARE](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#label-in-name)
Link to this section: Shortcut to copy the link: `ctrl`+`C` _or_ `⌘``C`
E-mail a link to this sectionClose
[ Back to top](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#top)
...
[ SHARE](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#motion-actuation)
Link to this section: Shortcut to copy the link: `ctrl`+`C` _or_ `⌘``C`
E-mail a link to this sectionClose
[ Back to top](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#top)
...
[ SHARE](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#target-size-enhanced)
Link to this section: Shortcut to copy the link: `ctrl`+`C` _or_ `⌘``C`
E-mail a link to this sectionClose
[ Back to top](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#top)
...
[ SHARE](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#concurrent-input-mechanisms)
Link to this section: Shortcut to copy the link: `ctrl`+`C` _or_ `⌘``C`
E-mail a link to this sectionClose
[ Back to top](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#top)
...
[ SHARE](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#dragging-movements)
Link to this section: Shortcut to copy the link: `ctrl`+`C` _or_ `⌘``C`
E-mail a link to this sectionClose
[ Back to top](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#top)
#### **2.5.8** Target Size (Minimum)
Level AA(Added in 2.2)
The size of the target for pointer inputs is at least 24 by 24 CSS pixels, except when:  Show Hide full description
...
[ SHARE](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#target-size-minimum)
Link to this section: Shortcut to copy the link: `ctrl`+`C` _or_ `⌘``C`
E-mail a link to this sectionClose
[ Back to top](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#top)
...
[ SHARE](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#language-of-page)
Link to this section: Shortcut to copy the link: `ctrl`+`C` _or_ `⌘``C`
E-mail a link to this sectionClose
[ Back to top](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#top)
...
[ SHARE](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#language-of-parts)
Link to this section: Shortcut to copy the link: `ctrl`+`C` _or_ `⌘``C`
E-mail a link to this sectionClose
[ Back to top](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#top)
#### **3.1.3** Unusual Words
...
[ SHARE](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#unusual-words)
Link to this section: Shortcut to copy the link: `ctrl`+`C` _or_ `⌘``C`
E-mail a link to this sectionClose
[ Back to top](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#top)
#### **3.1.4** Abbreviations
...
[ SHARE](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#abbreviations)
Link to this section: Shortcut to copy the link: `ctrl`+`C` _or_ `⌘``C`
E-mail a link to this sectionClose
[ Back to top](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#top)
#### **3.1.5** Reading Level
...
_Note:_ Different sites may address this success criterion in different ways. An audio version of the content may be helpful to some users. For some people who are deaf, a sign language version of the page may be easier to understand than a written language version since sign language may be their first language. Some sites may decide to do both or other combinations. No technique will help all users who have difficulty. So different techniques are provided as sufficient techniques here for authors trying to make their sites more accessible. Any numbered technique or combination above can be used by a particular site and it is considered sufficient by the Working Group.
[ SHARE](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#reading-level)
Link to this section: Shortcut to copy the link: `ctrl`+`C` _or_ `⌘``C`
E-mail a link to this sectionClose
[ Back to top](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#top)
#### **3.1.6** Pronunciation
...
[ SHARE](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#pronunciation)
Link to this section: Shortcut to copy the link: `ctrl`+`C` _or_ `⌘``C`
E-mail a link to this sectionClose
[ Back to top](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#top)
...
_Note:_ A change of content is not always a change of context. This success criterion is automatically met if changes in content are not also changes of context.
...
[ SHARE](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#on-focus)
Link to this section: Shortcut to copy the link: `ctrl`+`C` _or_ `⌘``C`
E-mail a link to this sectionClose
[ Back to top](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#top)
#### **3.2.2** On Input
...
[ SHARE](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#on-input)
Link to this section: Shortcut to copy the link: `ctrl`+`C` _or_ `⌘``C`
E-mail a link to this sectionClose
[ Back to top](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#top)
...
[ SHARE](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#consistent-navigation)
Link to this section: Shortcut to copy the link: `ctrl`+`C` _or_ `⌘``C`
E-mail a link to this sectionClose
[ Back to top](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#top)
...
Note: Other techniques may also be sufficient if they meet the success criterion. See [Understanding Techniques.](https://www.w3.org/WAI/WCAG22/Understanding/understanding-techniques)
  * [G197: Using labels, names, and text alternatives consistently for content that has the same functionality](https://www.w3.org/WAI/WCAG22/Techniques/general/G197) **AND** following the [sufficient techniques for Success Criterion 1.1.1](https://www.w3.org/WAI/WCAG22/quickref/non-text-content#techniques) and [sufficient techniques for Success Criterion 4.1.2](https://www.w3.org/WAI/WCAG22/quickref/name-role-value#techniques) for providing labels, names, and text alternatives.
...
[ SHARE](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#consistent-identification)
Link to this section: Shortcut to copy the link: `ctrl`+`C` _or_ `⌘``C`
E-mail a link to this sectionClose
[ Back to top](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#top)
...
[ SHARE](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#change-on-request)
Link to this section: Shortcut to copy the link: `ctrl`+`C` _or_ `⌘``C`
E-mail a link to this sectionClose
[ Back to top](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#top)
#### **3.2.6** Consistent Help
Level A(Added in 2.2)
If a web page contains any of the following help mechanisms, and those mechanisms are repeated on multiple web pages within a set of web pages, they occur in the same order relative to other page content, unless a change is initiated by the user:  Show Hide full description
...
_Note 1:_ Help mechanisms may be provided directly on the page, or may be provided via a direct link to a different page containing the information.
...
[ SHARE](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#consistent-help)
Link to this section: Shortcut to copy the link: `ctrl`+`C` _or_ `⌘``C`
E-mail a link to this sectionClose
[ Back to top](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#top)
...
[ SHARE](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#error-identification)
Link to this section: Shortcut to copy the link: `ctrl`+`C` _or_ `⌘``C`
E-mail a link to this sectionClose
[ Back to top](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#top)
...
_Note:_ The techniques at the end of the above list should be considered "last resort" and only used when the other techniques cannot be applied to the page. The earlier techniques are preferred because they increase accessibility to a wider user group.
...
[ SHARE](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#labels-or-instructions)
Link to this section: Shortcut to copy the link: `ctrl`+`C` _or_ `⌘``C`
E-mail a link to this sectionClose
[ Back to top](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#top)
...
[ SHARE](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#error-suggestion)
Link to this section: Shortcut to copy the link: `ctrl`+`C` _or_ `⌘``C`
E-mail a link to this sectionClose
[ Back to top](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#top)
#### **3.3.4** Error Prevention (Legal, Financial, Data)
Level AA
For web pages that cause legal commitments or financial transactions for the user to occur, that modify or delete user-controllable data in data storage systems, or that submit user test responses, at least one of the following is true:  Show Hide full description
...
[ SHARE](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#error-prevention-legal-financial-data)
Link to this section: Shortcut to copy the link: `ctrl`+`C` _or_ `⌘``C`
E-mail a link to this sectionClose
[ Back to top](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#top)
#### **3.3.5** Help
...
[ SHARE](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#help)
Link to this section: Shortcut to copy the link: `ctrl`+`C` _or_ `⌘``C`
E-mail a link to this sectionClose
[ Back to top](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#top)
#### **3.3.6** Error Prevention (All)
Level AAA
For web pages that require the user to submit information, at least one of the following is true:  Show Hide full description
  * **Reversible:** Submissions are reversible.
  * **Checked:** Data entered by the user is checked for input errors and the user is provided an opportunity to correct them.
  * **Confirmed:** A mechanism is available for reviewing, confirming, and correcting information before finalizing the submission.
...
Note: Other techniques may also be sufficient if they meet the success criterion. See [Understanding Techniques.](https://www.w3.org/WAI/WCAG22/Understanding/understanding-techniques)
  * Following the [sufficient techniques for Success Criterion 3.3.4](https://www.w3.org/WAI/WCAG22/quickref/error-prevention-legal-financial-data#techniques) for all forms that require the user to submit information.


[ SHARE](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#error-prevention-all)
Link to this section: Shortcut to copy the link: `ctrl`+`C` _or_ `⌘``C`
E-mail a link to this sectionClose
[ Back to top](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#top)
#### **3.3.7** Redundant Entry
Level A(Added in 2.2)
Information previously entered by or provided to the user that is required to be entered again in the same process is either:  Show Hide full description
  * auto-populated, or
...
[ SHARE](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#redundant-entry)
Link to this section: Shortcut to copy the link: `ctrl`+`C` _or_ `⌘``C`
E-mail a link to this sectionClose
[ Back to top](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#top)
#### **3.3.8** Accessible Authentication (Minimum)
Level AA(Added in 2.2)
A cognitive function test (such as remembering a password or solving a puzzle) is not required for any step in an authentication process unless that step provides at least one of the following:  Show Hide full description
...
_Note 1:_ "Object recognition" and "Personal content" may be represented by images, video, or audio.
...
[ SHARE](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#accessible-authentication-minimum)
Link to this section: Shortcut to copy the link: `ctrl`+`C` _or_ `⌘``C`
E-mail a link to this sectionClose
[ Back to top](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#top)
...
[ SHARE](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#accessible-authentication-enhanced)
Link to this section: Shortcut to copy the link: `ctrl`+`C` _or_ `⌘``C`
E-mail a link to this sectionClose
[ Back to top](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#top)
## **Principle 4** – Robust
...
_Note 1:_ This success criterion should be considered as always satisfied for any content using HTML or XML.
_Note 2:_
...
[ SHARE](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#parsing)
Link to this section: Shortcut to copy the link: `ctrl`+`C` _or_ `⌘``C`
E-mail a link to this sectionClose
[ Back to top](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#top)
...
###### Situation C: If using a standard user interface component in a programming technology:
  * [G135: Using the accessibility API features of a technology to expose names and roles, to allow user-settable properties to be directly set, and to provide notification of changes](https://www.w3.org/WAI/WCAG22/Techniques/general/G135) using technology-specific techniques below:
    * [PDF10: Providing labels for interactive form controls in PDF documents](https://www.w3.org/WAI/WCAG22/Techniques/pdf/PDF10)
    * [PDF12: Providing name, role, value information for form fields in PDF documents](https://www.w3.org/WAI/WCAG22/Techniques/pdf/PDF12)


###### Situation D: If creating your own user interface component in a programming language:
  * [G10: Creating components using a technology that supports the accessibility API features of the platforms on which the user agents will be run to expose the names and roles, allow user-settable properties to be directly set, and provide notification of changes](https://www.w3.org/WAI/WCAG22/Techniques/general/G10) using technology-specific techniques below:
...
[ SHARE](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#name-role-value)
Link to this section: Shortcut to copy the link: `ctrl`+`C` _or_ `⌘``C`
E-mail a link to this sectionClose
[ Back to top](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#top)
...
_Note:_ Not all examples in the preceding general techniques use status messages to convey warnings or errors to users. A role of "alert" is only necessary where a change of context does _not_ take place.
...
#####  Advisory Techniques for Success Criterion 4.1.3
  ...
  * Using aria-live regions to support [1.4.13 Content on Hover or Focus](https://www.w3.org/WAI/WCAG22/quickref/content-on-hover-or-focus) (future link)
...
[ SHARE](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#status-messages)
Link to this section: Shortcut to copy the link: `ctrl`+`C` _or_ `⌘``C`
E-mail a link to this sectionClose
[ Back to top](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.1#top)
Contribute
...
**Status:** Updated 26 Jun 2025. Previous editors and developers: [Shadi Abou-Zahra](https://www.w3.org/People/shadi/) (Project Lead), [Eric Eggert](https://www.w3.org/People/yatil/), Gregg Vanderheiden, Loretta Guarino Reid, Ben Caldwell, [Shawn Lawton Henry](https://www.w3.org/People/Shawn/), Gez Lemon. The 2016 redesign was developed by the Education and Outreach Working Group ([EOWG](https://www.w3.org/WAI/EO/)) and the Web Content Accessibility Guidelines Working Group ([WCAG WG](https://www.w3.org/WAI/GL/)), with support from the [WAI-DEV project](https://www.w3.org/WAI/DEV/), a project of the European Commission IST Programme.
  ...
  * [Contacting WAI](https://www.w3.org/WAI/contacts)


**Feedback welcome towai@w3.org (a WAI staff-only list).**
...
- Harvested: 2025-08-20T01:13:29.960378
- Profile: deep_research
- Agent: ux
