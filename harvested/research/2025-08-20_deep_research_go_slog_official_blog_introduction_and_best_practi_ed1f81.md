...
confidence: 0.95
harvested_at: '2025-08-20T00:35:49.052250'
profile: deep_research
source: https://go.dev/blog/slog
topic: Go slog official blog introduction and best practices
---

# Go slog official blog introduction and best practices

[ ![Go](https://go.dev/images/go-logo-white.svg) ](https://go.dev/)
[ Skip to Main Content ](https://go.dev/blog/slog#main-content)
  * [ Why Go _arrow_drop_down_ ](https://go.dev/blog/slog)
...
Press Enter to activate/deactivate dropdown 
  * [ Docs _arrow_drop_down_ ](https://go.dev/blog/slog)
Press Enter to activate/deactivate dropdown 
...
Press Enter to activate/deactivate dropdown 
  * [ Community _arrow_drop_down_ ](https://go.dev/blog/slog)
Press Enter to activate/deactivate dropdown 
...
[ ![Go.](https://go.dev/images/go-logo-blue.svg) ](https://go.dev/)
  * [Why Go _navigate_next_](https://go.dev/blog/slog)
[_navigate_before_ Why Go](https://go.dev/blog/slog)
    * [ Case Studies ](https://go.dev/solutions/case-studies)
    * [ Use Cases ](https://go.dev/solutions/use-cases)
    * [ Security ](https://go.dev/security/)
  * [Learn](https://go.dev/learn/)
  * [Docs _navigate_next_](https://go.dev/blog/slog)
[_navigate_before_ Docs](https://go.dev/blog/slog)
    * [ Go Spec ](https://go.dev/ref/spec)
    * [ Go User Manual ](https://go.dev/doc)
    * [ Standard library ](https://pkg.go.dev/std)
    * [ Release Notes ](https://go.dev/doc/devel/release)
    * [ Effective Go ](https://go.dev/doc/effective_go)
  * [Packages](https://pkg.go.dev)
  * [Community _navigate_next_](https://go.dev/blog/slog)
[_navigate_before_ Community](https://go.dev/blog/slog)
    * [ Recorded Talks ](https://go.dev/talks/)
    * [ Meetups _open_in_new_ ](https://www.meetup.com/pro/go)
    * [ Conferences _open_in_new_ ](https://go.dev/wiki/Conferences)
    * [ Go blog ](https://go.dev/blog)
...
## A tour of `slog`[¶](https://go.dev/blog/slog#a-tour-of-slog)
...
Initially, slog’s output goes through the default `log.Logger`, producing the output we’ve seen above. We can change the output by changing the _handler_ used by the logger. `slog` comes with two built-in handlers. A `TextHandler` emits all log information in the form `key=value`. This program creates a new logger using a `TextHandler` and makes the same call to the `Info` method:
```
...
## Performance[¶](https://go.dev/blog/slog#performance)
...
## The design process[¶](https://go.dev/blog/slog#the-design-process)
...
## Resources[¶](https://go.dev/blog/slog#resources)
...
The [wiki page](https://go.dev/wiki/Resources-for-slog) has additional resources provided by the Go community, including a variety of handlers.
...
**Next article:**[Perfectly Reproducible, Verified Go Toolchains](https://go.dev/blog/rebuild) **Previous article:**[Forward Compatibility and Toolchain Management in Go 1.21](https://go.dev/blog/toolchain) **[Blog Index](https://go.dev/blog/all)**
...
- Harvested: 2025-08-20T00:35:49.052250
- Profile: deep_research
- Agent: architect
