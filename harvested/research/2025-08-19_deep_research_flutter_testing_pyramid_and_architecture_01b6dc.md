...
confidence: 0.95
harvested_at: '2025-08-19T23:21:25.142380'
profile: deep_research
source: https://docs.flutter.dev/testing/overview
topic: Flutter Testing Pyramid and Architecture
---

# Flutter Testing Pyramid and Architecture
...
OK, got it
[ Skip to main content ](https://docs.flutter.dev/testing/overview#document-title)[ ![Flutter logo](https://docs.flutter.dev/assets/images/branding/flutter/logo/default.svg) Flutter Docs ](https://docs.flutter.dev/ "Go to the Flutter docs homepage")
...
list On this page chevron_right Testing Flutter apps
[ vertical_align_top Testing Flutter apps ](https://docs.flutter.dev/testing/overview#document-title)
  * [Unit tests](https://docs.flutter.dev/testing/overview#unit-tests)
  * [Widget tests](https://docs.flutter.dev/testing/overview#widget-tests)
  * [Integration tests](https://docs.flutter.dev/testing/overview#integration-tests)
  * [Continuous integration services](https://docs.flutter.dev/testing/overview#continuous-integration-services)
...
# Testing Flutter apps
  1. [ Testing & debugging ](https://docs.flutter.dev/testing)chevron_right
...
## Unit tests
[#](https://docs.flutter.dev/testing/overview#unit-tests)
...
_info_ Note
If you're writing unit tests for code that uses plugins and you want to avoid crashes, check out [Plugins in Flutter tests](https://docs.flutter.dev/testing/plugins-in-tests). If you want to test your Flutter plugin, check out [Testing plugins](https://docs.flutter.dev/testing/testing-plugins).
### Recipes
[#](https://docs.flutter.dev/testing/overview#recipes)
...
### Recipes
[#](https://docs.flutter.dev/testing/overview#recipes-1)
  * [Find widgets](https://docs.flutter.dev/cookbook/testing/widget/finders/)
  ...
  * [Test orientation](https://docs.flutter.dev/cookbook/testing/widget/orientation/)


## Integration tests
[#](https://docs.flutter.dev/testing/overview#integration-tests)
...
### Recipes
[#](https://docs.flutter.dev/testing/overview#recipes-2)
...
[#](https://docs.flutter.dev/testing/overview#continuous-integration-services)
...
[ bug_report Provide details ](https://github.com/flutter/website/issues/new?template=1_page_issue.yml&&page-url=https://docs.flutter.dev/testing/overview/&page-source=https://github.com/flutter/website/tree/main/src/content/testing/overview.md)
...
- Harvested: 2025-08-19T23:21:25.142380
- Profile: deep_research
- Agent: architect
