...
confidence: 0.95
harvested_at: '2025-08-19T01:10:44.108637'
profile: deep_research
source: https://ai.pydantic.dev
topic: PydanticAI-agent-framework
---
...
[ pydantic/pydantic-ai 
  ...
  * Introduction  [ Introduction  ](https://ai.pydantic.dev/) Table of contents 
    * [ Why use Pydantic AI  ](https://ai.pydantic.dev/#why-use-pydantic-ai)
...
# Introduction
![Pydantic AI](https://ai.pydantic.dev/img/pydantic-ai-dark.svg#only-dark)
![Pydantic AI](https://ai.pydantic.dev/img/pydantic-ai-light.svg#only-light)
...
## Why use Pydantic AI
  * **Built by the Pydantic Team** : Built by the team behind [Pydantic Validation](https://docs.pydantic.dev/latest/) (the validation layer of the OpenAI SDK, the Anthropic SDK, LangChain, LlamaIndex, AutoGPT, Transformers, CrewAI, Instructor and many more).
  ...
  * **Structured Responses** : Harnesses the power of [Pydantic Validation](https://docs.pydantic.dev/latest/) to [validate and structure](https://ai.pydantic.dev/output/#structured-output) model outputs, ensuring responses are consistent across runs.
...
result = agent.run_sync('Where does "hello world" come from?') [](https://ai.pydantic.dev/#__code_0_annotation_3)
print(result.output)
"""
...
classSupportOutput(BaseModel): [](https://ai.pydantic.dev/#__code_1_annotation_13)
...
"""Returns the customer's current account balance.""" [](https://ai.pydantic.dev/#__code_1_annotation_7)
...
async defmain():
  ...
  print(result.output) [](https://ai.pydantic.dev/#__code_1_annotation_10)
"""
...
frombank_databaseimport DatabaseConn
importlogfire
logfire.configure() [](https://ai.pydantic.dev/#__code_2_annotation_1)
logfire.instrument_asyncpg() [](https://ai.pydantic.dev/#__code_2_annotation_2)
...
## llms.txt
The Pydantic AI documentation is available in the [llms.txt](https://llmstxt.org/) format. This format is defined in Markdown and suited for large language models.
...
- Harvested: 2025-08-19T01:10:44.108637
- Profile: deep_research
- Agent: architect
