...
confidence: 0.95
harvested_at: '2025-08-19T11:38:05.280515'
profile: deep_research
source: https://docs.flutter.dev/data-and-backend/networking
topic: Flutter Background Sync and Network Management
---

# Flutter Background Sync and Network Management
...
OK, got it
[ Skip to main content ](https://docs.flutter.dev/data-and-backend/networking#document-title)[ ![Flutter logo](https://docs.flutter.dev/assets/images/branding/flutter/logo/default.svg) Flutter Docs ](https://docs.flutter.dev/ "Go to the Flutter docs homepage")
...
list On this page chevron_right Samples
[ vertical_align_top Networking ](https://docs.flutter.dev/data-and-backend/networking#document-title)
  * [Cross-platform http networking](https://docs.flutter.dev/data-and-backend/networking#cross-platform-http-networking)
  * [Platform notes](https://docs.flutter.dev/data-and-backend/networking#platform-notes)
    * [Android](https://docs.flutter.dev/data-and-backend/networking#android)
    * [macOS](https://docs.flutter.dev/data-and-backend/networking#macos)
  * [Samples](https://docs.flutter.dev/data-and-backend/networking#samples)
...
# Networking
  1. [ Data & backend ](https://docs.flutter.dev/data-and-backend)chevron_right
  2. [ Networking ](https://docs.flutter.dev/data-and-backend/networking)


## Cross-platform http networking
[#](https://docs.flutter.dev/data-and-backend/networking#cross-platform-http-networking)
...
### Android
[#](https://docs.flutter.dev/data-and-backend/networking#android)
...
## Samples
[#](https://docs.flutter.dev/data-and-backend/networking#samples)
...
[ bug_report Provide details ](https://github.com/flutter/website/issues/new?template=1_page_issue.yml&&page-url=https://docs.flutter.dev/data-and-backend/networking/&page-source=https://github.com/flutter/website/tree/main/src/content/data-and-backend/networking.md)
...
- Harvested: 2025-08-19T11:38:05.280515
- Profile: deep_research
- Agent: architect
