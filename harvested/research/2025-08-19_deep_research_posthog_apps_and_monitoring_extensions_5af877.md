...
confidence: 0.95
harvested_at: '2025-08-19T22:09:17.310433'
profile: deep_research
source: https://posthog.com/docs/apps/overview
topic: PostHog Apps and Monitoring Extensions
---

# PostHog Apps and Monitoring Extensions
...
![The stars in the sky](https://res.cloudinary.com/dmukukwp6/image/upload/v1/posthog.com/src/images/galaxy-1)
![More stars in the sky](https://res.cloudinary.com/dmukukwp6/image/upload/v1/posthog.com/src/images/galaxy-2)
**404:** ~~Hog~~ Page not found
## Lost in space
### Try a search to beam back to PostHog.com:
Search...
Searches: Docs, API, Tutorials, Blog, Community Questions, and Company Handbook – _and it's actually pretty good!_
[ Take me back to the homepage](https://posthog.com/)
Think this is a mistake? [Raise an issue](https://github.com/PostHog/posthog.com/issues) and we'll fix it!
[](https://posthog.com/)
  * #### [Products](https://posthog.com/products)
...
## Source Information
- URL: https://posthog.com/docs/apps/overview
- Harvested: 2025-08-19T22:09:17.310433
- Profile: deep_research
- Agent: architect
